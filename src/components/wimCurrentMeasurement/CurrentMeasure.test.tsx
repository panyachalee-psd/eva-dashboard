...
describe('<CurrentMeasureTable />', () => {
  ...
  it('applies red color only when isOverweight = true', async () => {
    ...
    await waitFor(() => {
      const normalCell = screen.getByTestId('weight-15fb6602-6c0a-4f8f-9620-fa92c4a66c13');
      const overweightCell = screen.getByTestId('weight-17351907-89be-4a0e-9bdf-f6a9b7045e57');
  ...
  it('renders fallback for null/undefined values', async () => {
    ...
    await waitFor(() => {
      ...
      // Null weight
      // const weightCell = screen.getByTestId('weight-id-3');
...
describe('formatDate', () => {
  it('formats ISO string correctly', () => {
    const isoString = '2025-11-24T12:34:56.789Z';
    const formatted = formatDate(isoString);

    // Should be in "yyyy-MM-dd HH:mm:ss" format
    // expect(formatted).toBe('2025-11-24 12:34:56');
    // expect(formatDate("2025-11-24T12:34:56Z")).toBe(
  // new Date("2025-11-24T12:34:56Z").toLocaleString("en-US", { hour12: false })
...
// );
  ...
  it('handles invalid date string gracefully', () => {
    ...
    // Invalid date should result in "Invalid Date" string
